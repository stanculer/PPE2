        ...
        <div class="container-fluid">
            <div class="row fullscreen align-items-center justify-content-center">
                <div class="col-lg-6 col-md-12 d-flex align-self-end img-right no-padding">
                    <img class="img-fluid" src="img/PPE2/borne-tactile-portrait-point-and-click-multitouch.png" alt="">
                </div>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-40">
                    <div class="title text-center">
                        <h1 class="mb-10">Les diffents produit proposées</h1>
                        <p>Choisit le bon </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 mb-30">
                <div class="content">
                    <a target="_blank">
                        <div class="content-overlay"></div>
                        <img class="content-image img-fluid d-block mx-auto" src="img/PPE2/borne-tactile-portrait-point-and-click-multitouch.png" alt="">
                        <div class="content-details fadeIn-bottom">
                            <h3 class="content-title">Borne photo</h3>
                        </div>
                    </a>
                </div>
            </div>
